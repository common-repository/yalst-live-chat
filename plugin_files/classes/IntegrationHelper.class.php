...
?>
		...
		<div class="metabox-holder">
			<div class="postbox">
				...
				<li><input type="radio" name="integration" id="integration_4" <? if ($tabIndex == '4') {echo 'checked="checked"';}?>> <label for="integration_4"><? _e( 'Auf allen Seiten als Chat in der Webseite', 'yalst_text' ); ?></label></li>
		...
		<!-- Tab-Chat -->
		<div class="metabox-holder" id="tabchatIntegration" style="display:none">
			<div class="postbox">				
				<div class="postbox_content">
					<div class="example">
						<img src="<?php echo yalstGeneral::get_instance()->get_plugin_url(); ?>/images/tabchat.png" />
					</div>
					<div class="rechte_seite">
						<div class="explain_header">
						<? _e( 'Kopieren Sie hierher bitte den Einbindungscode.', 'yalst_text' ); ?>
						</div>
						<? if (get_option('isAddedTab') != 0): ?>
							<div class="explain_text">
							<span class="rot"><? _e( 'Tab-Chat wurde hinzugefügt.', 'yalst_text' ); ?></span>
							</div>
							<? update_option('isAddedTab',0) ?>
						<? endif; ?>
						
						<div class="explain_textfield">
							<form method="post" action="?page=yalst_integration" id="save_yalst_tabchat_integration">
								<textarea name="yalstTabChatIntegrationInput" id="yalstTabChatIntegration" cols="40" rows="7" required /><?php echo get_option("yalstTabChatIntegrationInput", ""); ?></textarea>
								<input type="hidden" name="yalstTabChatIntegration" value="1">
						...
						<div class="explain_text">
							...
							<? _e( 'Ein Tab erscheint dann auf jeder Seite und nach dem Klick startet der Chat.', 'yalst_text' ); ?>
						</div>			
						<div class="explain_text">
							<? _e( 'Tip: Zusätzliche Einbindungen (wie z.B. Warenkorbmonitoring usw.) können über Widgets eingebaut werden', 'yalst_text' ); ?>
						</div>
						<div class="explain_button">
