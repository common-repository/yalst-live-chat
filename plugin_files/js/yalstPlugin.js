...
var yalst =
{
	...
	toggleIntegrationForm: function()
	{
		var toggleIntegrationForm = function()
		{
			...
			else if ($('#integration_4').is(':checked'))
			{
				$('#deactiveIntegration').hide();
				$('#reiterIntegration').hide();
				$('#reiterWidgetIntegration').hide();
				$('#widgetIntegration').hide();
				$('#tabchatIntegration').show();
			}
		};
	...
	{
		Array.prototype.forEach.call(document.querySelectorAll("#yalstReiterIntegration, #yalstReiterWidgetIntegration, #yalstTabChatIntegration"),
		function(textArea)
			{
